...
urlpatterns = [
    ...
    url(r'^professores/(?P<pk>[0-9]+)/$', views.ProfessorRetrieve.as_view()),
    ...
    url(r'^tecnicos/(?P<pk>[0-9]+)/$', views.TecnicoRetrieve.as_view()),
    ...
    url(r'^alunos/(?P<pk>[0-9]+)/$', views.AlunoRetrieve.as_view()),
