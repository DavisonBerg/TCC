...
urlpatterns = [
    ...
    url(r'^professores/(?P<tag>[0-9]+)/$', views.ProfessorRetrieve.as_view()),
    ...
    url(r'^tecnicos/(?P<tag>[0-9]+)/$', views.TecnicoRetrieve.as_view()),
    ...
    url(r'^alunos/(?P<tag>[0-9]+)/$', views.AlunoRetrieve.as_view()),
